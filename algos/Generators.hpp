...
std::function<WATT_RO_NoRAND_OneEVICT_HISTORY_Track_writes()> WATT_RO_NoRAND_OneEVICT_HISTORY_Track_writes_Generator(int K, int out_of_ram_history_length, bool writes_as_reads = true, uint epoch_size = 1);
